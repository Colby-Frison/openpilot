...
def system_daemon_params():
  ...
  from openpilot.system.test.support.params_seed import seed_system_daemon_params
...
def system_full_stack_params():
  ...
  from openpilot.system.test.support.params_seed import seed_full_stack_params
...
def system_pub_sub_factory():
  """Maps: infra. Build ``PubMaster`` / ``SubMaster`` via :func:`openpilot.system.test.support.messaging.make_pub_sub`."""
